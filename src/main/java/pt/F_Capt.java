...
public class F_Capt {
    ...
    public static void main(String[] args) {
        try {
            F_Capt fcapt = new F_Capt();
         /*   String token = fcapt.login();
         ...
         // System.out.println(cookies);
            String cookies = STATIC_COOKIES;
            fcapt.parseList(fcapt.getList(cookies));
       //    fcapt.parseApplication("171378",cookies);
        } catch (Exception e) {
    ...
    public String getList(String cookies){
        String reponse = null;
        ...
        String authorization = STATIC_AUTHORIZATION;
        return HttpsHandler.sendGet(url,getParam,"UTF-8",cookies,authorization);
    }
    ...
    public void parseApplication(String appID,String cookies){
        ...
        String authorization = STATIC_AUTHORIZATION;
        String rtn= HttpsHandler.sendGet(url,getParam,"UTF-8",cookies,authorization);
